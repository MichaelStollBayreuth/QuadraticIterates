...
\cite{li2020, li2021} that extend the last theorem of the paper to further values of $a$ (one of
them, Theorem~\ref{thm:li-A}, in a stronger form); it records the mathematics in the notation of
Chapter~2 and how the proofs reduce to the material of Chapters~2--4. Chapter~6 extends the Section~3 theorem to rational parameters $a = r/s$
