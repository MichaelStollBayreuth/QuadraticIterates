...
\begin{lemma}
  ...
  \lean{QuadraticIterates.not_isSquare_betaSeq, QuadraticIterates.gammaSeq_mul_eq_two_mul,
    QuadraticIterates.prod_gammaSeq_mul_eq, QuadraticIterates.gammaSeq_gcd,
...
\begin{proof}
  \leanok
  \uses{lem:moebiussign, lem:zmodsquare}
