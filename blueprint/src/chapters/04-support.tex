...
\begin{lemma}[Möbius sums]
  ...
  \lean{Squarefree.exists_disjoint_union_eq_divisors_moebius_div, ArithmeticFunction.prod_pow_moebius_eq_div, ArithmeticFunction.sum_divisorsAntidiagonal_moebius_eq_zero,
