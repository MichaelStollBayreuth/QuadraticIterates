...
\begin{lemma}[Degree of a multiquadratic extension]
  ...
  \lean{multiquadraticRelations, mem_multiquadraticRelations, multiquadratic_degree,
    ...
    finrank_adjoin_sqrt_eq, multiquadraticRelations_finrank_le,
...
\begin{lemma}[Square descent]
  \label{lem:descent}
  \uses{def:twoindep}
  \lean{square_descent, exists_sq_eq_algebraMap_of_isSquare_mul_prod, square_descent_step,
    isSquare_algebraMap_iff,
