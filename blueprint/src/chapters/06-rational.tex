...
\begin{proof}
  ...
  general modulus $M$ with $s$ a unit modulo $M$ and ``not a square in \lname{ZMod M}'' in place
  of the odd prime $p$ with Legendre symbol $-1$ and of the modulus $4$, which it subsumes
