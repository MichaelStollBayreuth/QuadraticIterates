...
\begin{theorem}[Theorem R${}^+$]
  ...
  \lean{QuadraticIterates.nonempty_mulEquiv_of_neg_lt_of_twoAdicClass_of_squarefreeCert,
    QuadraticIterates.nonempty_mulEquiv_of_twoAdicClass_of_squarefreeCert,
    QuadraticIterates.SquarefreeCert}
  \leanok
...
\begin{proof}
  ...
  \lname{nonempty\_mulEquiv\_of\_twoAdicClass\_of\_squarefreeCert} takes the sign
  ...
  \lname{SquarefreeCert r s ε}, an inductive predicate with one constructor per mechanism of the
  ...
  $4$, which it subsumes
  (\lname{not\_isSquare\_betaInt\_of\_squarefree\_of\_squarefreeCert}). Theorem R${}^+$ is the
...
\begin{theorem}[Theorem R${}^-$]
  ...
  \lean{QuadraticIterates.nonempty_mulEquiv_of_two_mul_le_neg_of_twoAdicClass_of_squarefreeCert}
  \leanok
...
\begin{proof}
  ...
  certificate \lname{SquarefreeCert (-r) s (-1)} and the positivity of $w^S$ from
...
\item \lname{Rational/Main.lean}: the certificate predicate \lname{SquarefreeCert}, the uniform
  theorem \lname{nonempty\_mulEquiv\_of\_twoAdicClass\_of\_squarefreeCert}, and Theorems
