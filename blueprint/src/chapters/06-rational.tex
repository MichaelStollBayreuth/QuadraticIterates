...
\begin{definition}[the integer Möbius factors]
  ...
  that the denominators produce, \lname{even\_sum\_two\_pow\_mul\_sub\_one\_of\_squarefree}
  ($k \ge 2$) and \lname{odd\_sum\_two\_pow\_sub\_one\_of\_squarefree} ($k = 1$) in
  \lname{Reflection.lean}, from the balanced sign partition
  \lname{card\_divisors\_eq\_two\_mul\_of\_squarefree}.}
\end{definition}
