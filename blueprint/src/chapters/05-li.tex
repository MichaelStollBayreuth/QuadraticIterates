...
\begin{lemma}[$a \equiv 3 \bmod 4$]
  \label{lem:li-mod4-3}
  \lean{QuadraticIterates.gammaSeq_normPoly_zmod_four_of_emod_four_eq_three, QuadraticIterates.gammaSeq_normPoly_add_succ_emod_four, QuadraticIterates.gammaSeq_eq_ite_even_of_eval_one_eq_zero}
  \leanok
  \uses{def:normpoly}
...
\begin{proof}
  ...
  $182$ and $2$), and the odd part is what the argument uses. The coprimality argument above is
  the Bézout-style \lname{isCoprime\_of\_mul\_eq} inside the Lean proof.}
\end{proof}
