...
\begin{definition}[The rescaled polynomial]
  ...
  iteration sequence satisfies $\gamma_n \cdot |a| = |c_n|$ for all $n \ge 1$; in particular all
  $\gamma_n$ are positive, and $\beta_n = |b_n|$ for $n \ge 2$.
...
\begin{proof}
  ...
  hypothesis a) of Lemma~\ref{lem:2.2} and the other two hypothesis b).}
\end{proof}
